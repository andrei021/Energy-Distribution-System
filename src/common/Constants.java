...
public final class Constants {
    ...
    public static final String NUM_OF_TURNS = "numberOfTurns";
    ...
    public static final String INITIAL_INFRASTRUCTURE_COST =
            "initialInfrastructureCost";
    public static final String INITIAL_PRODUCTION_COST =
